<section class="">
        <div class="gap-16 items-center py-12 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-50 sm:text-lg">
                <div class="mb-2">
                <h2 class="text-4xl tracking-tight font-extrabold text-white">Meet Jackson Maddox</h2>
                <span>Engineer | Mixer | Producer</span><br>
                <span><i>BlackBird Studio (2020)</i></span>
                </div>
                <p class="mb-4">An experienced audio engineer based in Nashville, specializing in offering comprehensive recording, mixing, and mastering services tailored to bring out the best in your music.
                </p>
